...
return [
    ...
    'groups' => [
        ...
        'reviews' => [
            'label' => 'Review Prompt',
            'description' => 'The "leave a review" popup: how often visitors are asked, and where each platform sends them. App visitors go to the App Store or Google Play; website visitors go to Google Reviews.',
        ],
        'system' => [
            'label' => 'System',
    ...
    'definitions' => [
        ...
        'review_prompt_enabled' => [
            'group' => 'reviews',
            'label' => 'Enable the review prompt',
            'type' => 'bool',
            'input' => 'toggle',
            'default' => true,
            'rules' => ['boolean'],
            'hint' => 'Master switch. When off, the popup never appears on the website or in either app.',
        ],
        'google_review_link' => [
            'group' => 'reviews',
            ...
            'default' => null,
            'rules' => ['nullable', 'string', 'max:500'],
            'hint' => 'Where website visitors go to leave a Google review. Get it from the Business Profile: search your business name while signed in, open "Ask for reviews" / "Get more reviews", and copy the review link (it looks like https://g.page/r/XXXXXXXX/review). A raw Place ID also works. Leave blank to hide the popup on the website.',
        ],
        'review_prompt_min_page_views' => [
            'group' => 'reviews',
            'label' => 'Minimum pages viewed',
            'type' => 'int',
            'input' => 'number',
            'default' => 4,
            'rules' => ['required', 'integer', 'between:1,100'],
            'hint' => 'How many pages a visitor must view before they are asked. Higher means fewer but better-qualified prompts.',
        ],
        'review_prompt_min_sessions' => [
            ...
            'hint' => 'How many separate visits (30+ minutes apart) before the prompt appears.',
        ],
        'review_prompt_min_days' => [
            'group' => 'reviews',
            'label' => 'Minimum days since first visit',
            'type' => 'int',
            'input' => 'number',
            'default' => 2,
            'rules' => ['required', 'integer', 'between:0,365'],
            'hint' => 'Wait this many days after someone first arrives before asking. Set 0 to ask on the first day.',
        ],
        'review_prompt_snooze_days' => [
            'group' => 'reviews',
            'label' => 'Days to wait after "Maybe later"',
            'type' => 'int',
            'input' => 'number',
            'default' => 90,
            'rules' => ['required', 'integer', 'between:1,730'],
            'hint' => 'A dismissed prompt stays hidden for this long. Nobody is asked more than three times in total.',
        ],
        'review_feedback_email' => [
            ...
            'default' => null,
            'rules' => ['nullable', 'email', 'max:255'],
            'hint' => 'Where the popup\'s "Send us feedback" button opens a message to. Falls back to the developer alert email when blank.',
        ],
