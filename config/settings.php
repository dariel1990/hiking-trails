...
return [
    ...
    'groups' => [
        ...
        'theme' => [
            'label' => 'Theme',
            'description' => 'Public site colors and fonts. Leave everything at defaults to keep the original hand-tuned design — overrides are only applied for values you change.',
        ],
        'system' => [
            'label' => 'System',
    ...
    'definitions' => [
        ...
        'theme_brand_color' => [
            ...
            'hint' => 'Deep teal used for the header, footer, links and primary UI across the public site. All lighter and darker shades are derived automatically.',
        ],
        'theme_accent_color' => [
            'group' => 'theme',
            'label' => 'Accent color',
            ...
            'default' => '#E87B35',
            'rules' => ['required', 'regex:/^#[0-9a-fA-F]{6}$/'],
            'hint' => 'Warm orange used for highlights, calls to action and the header tagline.',
        ],
        'theme_action_color' => [
            'group' => 'theme',
            'label' => 'Action color',
            ...
            'default' => '#10b981',
            'rules' => ['required', 'regex:/^#[0-9a-fA-F]{6}$/'],
            'hint' => 'Green used for buttons, badges, success states and interactive highlights.',
        ],
        'theme_heading_font' => [
            'group' => 'theme',
            'label' => 'Heading font',
            'type' => 'string',
            'input' => 'select',
            'options_config' => 'theme-fonts',
            'default' => 'Playfair Display',
            'rules' => ['required', 'in:Inter,Playfair Display,Oswald,Montserrat,Poppins,Lora,Merriweather,Nunito,Raleway,Source Sans 3,Work Sans'],
            'hint' => 'Used for large page titles (h1, h2).',
        ],
        'theme_subheading_font' => [
            ...
            'default' => 'Oswald',
            'rules' => ['required', 'in:Inter,Playfair Display,Oswald,Montserrat,Poppins,Lora,Merriweather,Nunito,Raleway,Source Sans 3,Work Sans'],
            'hint' => 'Used for section headings (h3–h6).',
        ],
        'theme_body_font' => [
            'group' => 'theme',
            'label' => 'Body font',
            ...
            'default' => 'Inter',
            'rules' => ['required', 'in:Inter,Playfair Display,Oswald,Montserrat,Poppins,Lora,Merriweather,Nunito,Raleway,Source Sans 3,Work Sans'],
            'hint' => 'Used for paragraphs, navigation and all general text.',
        ],
