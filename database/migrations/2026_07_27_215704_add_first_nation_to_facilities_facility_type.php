...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE facilities MODIFY facility_type ENUM('parking', 'toilets', 'emergency_kit', 'lodge', 'viewpoint', 'info', 'picnic', 'water', 'shelter', 'camping_site', 'point_of_interest', 'aid_station', 'bridge', 'trail_sign', 'ttf', 'first_nation') NOT NULL");
    }
