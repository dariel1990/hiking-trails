            ...
            <div class="grid md:grid-cols-12 gap-8 text-center md:text-left">
                ...
                <div class="md:col-span-3">
                    ...
                    <div class="space-y-6 flex flex-col items-center md:items-start">
                        ...
                        @php($socialLinks = collect(setting('social_links'))->filter(fn ($link): bool => is_array($link) && ! empty($link['url'])))
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap gap-3 justify-center md:justify-start">
                                ...
                                <a href="{{ $link['url'] }}" target="_blank" rel="noopener noreferrer"
                                    ...
                                    class="w-10 h-10 bg-green-700/60 hover:bg-accent-500 rounded-lg flex items-center justify-center transition-colors duration-300 group">
                                    <x-social-icon :icon="$link['icon'] ?? 'link'" class="w-5 h-5 text-gray-300 group-hover:text-white" />
                                </a>
                                @endforeach
                            </div>
                        </div>
