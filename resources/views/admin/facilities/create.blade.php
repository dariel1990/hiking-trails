                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                ...
                                <div class="mt-3 pt-3 border-t border-gray-100 space-y-2">
                                    ...
                                    <div id="facility-icon-image-preview" class="hidden items-center gap-2 text-xs text-green-700 bg-green-50 border border-green-200 rounded-md px-3 py-1.5">
                                        <img id="facility-icon-image-preview-img" src="" alt="" class="w-6 h-6 object-contain rounded">
                                        <span id="facility-icon-image-name" class="truncate flex-1"></span>
                                    ...
                                    <input type="hidden" name="icon_image" id="facility-icon-image-path" value="{{ old('icon_image') }}">
                                    @error('icon_image')
