...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold text-gray-900">Create Trail Network</h1>
    </div>

    <!-- Form -->
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('admin.trail-networks.store') }}" method="POST">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="text-sm text-gray-600 mb-3">Click on the map to set the center point of this trail network</p>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const map = L.map('coordinate-map').setView([54.7804, -127.1698], 11);
