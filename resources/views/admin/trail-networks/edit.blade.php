                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <select name="season" id="season" required
                                    ...
                                    <option value="summer" {{ old('season', $trailNetwork->season) === 'summer' ? 'selected' : '' }}>☀️ Summer only</option>
                                    <option value="winter" {{ old('season', $trailNetwork->season) === 'winter' ? 'selected' : '' }}>❄️ Winter only</option>
                                    <option value="both" {{ old('season', $trailNetwork->season) === 'both' ? 'selected' : '' }}>Both seasons</option>
                                </select>
                    ...
                    <div class="px-6 py-5 space-y-5">
                        ...
                        <label for="is_active"
                            ...
                            <input type="checkbox" name="is_active" id="is_active" value="1"
                                   {{ old('is_active', $trailNetwork->is_active) ? 'checked' : '' }}
                                   class="mt-0.5 h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded">
                            <div>
