                    ...
                    <div class="space-y-2">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="pt-3 border-t border-gray-200 space-y-2">
                                ...
                                <div id="activity-icon-image-preview" class="{{ $activityType->icon_image ? 'flex' : 'hidden' }} items-center gap-2 text-xs text-green-700 bg-green-50 border border-green-200 rounded-md px-3 py-1.5">
                                    <img id="activity-icon-image-preview-img" src="{{ $activityType->icon_image ? Storage::url($activityType->icon_image) : '' }}" alt="" class="w-6 h-6 object-contain rounded">
                                    <span id="activity-icon-image-name" class="truncate flex-1">{{ $activityType->icon_image ? basename($activityType->icon_image) : '' }}</span>
                                ...
                                <input type="hidden" name="icon_image" id="activity-icon-image-path" value="{{ old('icon_image', $activityType->icon_image) }}">
                                @error('icon_image')
                                    <p class="text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
